...
# Read data from 'longform.csv' and perform initial cleaning and exploration
# Results saved to 'data/1Extract.rda'
#
# 'longform.csv' generated by exporting the longform table from the SQLite database retrieved here:
...
sum(dat$section == '')
head(sort(unique(dat$section)), 20)
